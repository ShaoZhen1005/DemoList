...
public class Path_Search_View extends View {
    ...
    public Path_Search_View(Context context) {
        this(context, null);
    }

    public Path_Search_View(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAll();
        initPaint();
        initHandler();
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                if (x + getLeft() < getRight() && y + getTop() < getBottom()) {
                    ...
                    mViewClick.onClick(x - startRawX, y - startRawY);
                    mCurrentState = State.STARTING;
                    mStartingAnimator.start();
                }
                break;
